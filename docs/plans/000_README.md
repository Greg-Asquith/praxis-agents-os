...
acknowledgement, and full-figure PNG export. Slice F remains TODO.
...
| 041b | Structured untrusted content + rich provider tool UI — presenter kits and safe content preview                         | P1       | L      | 041, 042                                                               | IN PROGRESS (Slices A–B DONE 2026-07-22; Slice C DONE 2026-07-23 — preview backend, auto-rendered HTML email, images on by default, labels/thread chips, no reply automation, and centred search-row popover drill-in landed; Slice D DONE 2026-07-23 — shared table/KPI kits and rich Google Ads report, account, and governed campaign-status presenters landed, with ordinary typed Ads values and no model framing/legacy decoder per operator decision; Slice E DONE 2026-07-23 — always-auto-mounted core `build_chart`, compact defaulted multi-axis contract, theme-aware colours with optional brand hex overrides, compact model acknowledgements, native Recharts v3 renderer, and full-figure PNG export; Slice F TODO) |
...
| 079  | Inbound event receipt spine + Airtable webhooks                                                                        | P2       | L      | 030, 037–039, 041, 054, 077                                            | TODO (next sequenced item; plan doc authoring is unblocked)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
- `079` has a reserved number and README row but no plan document yet. Plan
  041 and the sequenced 082 catalogue prerequisite have now landed, so 079 is
  the next item; re-check the recorded provider facts when authoring it.
