...
location metadata. Slices B–D (schema cache/job, tools, and UI/docs/live QA)
remain pending; live sandbox QA for Slice A was unavailable because no
BigQuery credential is configured locally.
...
| 089  | Google BigQuery provider — service accounts, dataset context, cached schemas, SELECT-only queries (D14)                | P2       | L      | 030, 037–041 (all DONE); interleaves after 079; no Phase 4b dependency | IN PROGRESS — Slice A DONE 2026-07-28; Slices B–D TODO                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
