...
Plan 045 Slice A completed 2026-07-24. The shared retrieval package now
provides weighted reciprocal-rank fusion and the disabled-by-default reranker
seam. Knowledge search combines lexical, collection-guarded semantic, and
eligible-source recency ranks in one bounded SQL statement; all candidate
paths enforce workspace, deletion, privacy, source, and document filters before
fusion, while query-embedding failures degrade explicitly to lexical search.
Read-only workspace members can use the two authenticated, workspace-explicit
search/document routes, and hidden documents remain indistinguishable from
absence. The Slice A gate passed 7 pure retrieval tests and 78 database-backed
KB/route/contract tests, including the transaction and route smoke. Plan 045
remains IN PROGRESS until Slice B lands the Gate G4 corpus and eval harness.
...
| 045  | Hybrid search engine, KB routes, and the Gate G4 eval harness                                                          | P1       | L      | 044                                                                    | IN PROGRESS — Slice A DONE 2026-07-24; Slice B Gate G4 eval harness remains                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
