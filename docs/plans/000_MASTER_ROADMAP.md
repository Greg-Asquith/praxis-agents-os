...
| 039 | Async resource discovery via jobs, resource selection, connection status machine. **Slice A DONE 2026-07-17** (engine, status recomputation, notifications, retention and periodic re-discovery); Slice B selection/routes pending. (Donor C3.) |
