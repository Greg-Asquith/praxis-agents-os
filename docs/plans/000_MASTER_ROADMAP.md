...
remain as references: the donor roadmap (§4) holds the subsystem _designs_;
...
| Plan | Scope                                                                                                                                                                                                                                                                                                   |
| ---- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 034  | Agent file tools plus scratch model (TTL, size cap) and `<available_files>` prompt block via the 018 assembler. **DONE 2026-07-06; Plan 050 later retired the agent-visible scratch draft/promote workflow.** (Donor B5.)                                                                           |
...
| Plan | Scope                                                                                                                                                                                                                                                                                                                  |
| ---- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 050  | `Artifact` / immutable `ArtifactRevision` models + `create_artifact`/`update_artifact` registry tools + serving route with the three-layer defense (opaque-origin sandbox, `ARTIFACT_ORIGIN`, strict self-contained CSP with no external hosts and `connect-src 'none'`, amended by completed Plan 070). Local dev: srcdoc + sandbox; separate origin required only when share links ship. **DONE 2026-07-28.** (Donor F1.) |
| 051  | Chat artifact cards, first-class artifact list/detail/version/edit/diff/restore UI, and hardened anonymous share links (hashed ≥128-bit tokens, version-pinned, expiring/revocable, audited, rate-limited, swept, cookie-free, and served from a distinct HTTPS site). **DONE 2026-07-28.** (Donor F2.) |
