...
context-group machinery without provider branches. Slices B–D remain pending;
live sandbox QA was unavailable because no local BigQuery credential is
configured.
