...
- **Pending overlap**: skills plans 016–020 (TODO) — skills are instruction
  packages, deliberately orthogonal to tool grants (a donor decision worth
  keeping). Plan 017's document pipeline shares machinery with file
  processing here; sequence accordingly.
