...
from services.kb.ensure_reconcile_job import ensure_kb_reconcile_job
...
async def run_once(
    *,
    ...
    from services.jobs.handlers.sweep_platform_artifacts import ensure_platform_artifacts_sweep_job
    ...
    async with session_factory() as db:
        ...
        await ensure_platform_artifacts_sweep_job(db)
        ...
        await ensure_kb_reconcile_job(db)
