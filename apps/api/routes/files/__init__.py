...
from routes.files.create_folder import router as create_folder_router
from routes.files.delete_file import router as delete_file_router
from routes.files.delete_folder import router as delete_folder_router
...
router.include_router(list_folders_router)
router.include_router(update_folder_router)
router.include_router(delete_folder_router)
router.include_router(move_files_router)
