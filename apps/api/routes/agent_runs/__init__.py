...
from routes.agent_runs.list_pending_approvals import router as list_pending_approvals_router
from routes.agent_runs.resume_run import router as resume_run_router
from routes.agent_runs.review_approval import router as review_approval_router

router = APIRouter(prefix="/agent-runs", tags=["agent-runs"])
router.include_router(list_pending_approvals_router)
...
router.include_router(review_approval_router)
