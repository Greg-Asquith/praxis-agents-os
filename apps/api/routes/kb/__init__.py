...
from routes.kb.create_document_from_integration import (
    router as create_document_from_integration_router,
)
...
from routes.kb.search_integration_sources import router as search_integration_sources_router
...
router.include_router(create_document_from_integration_router)
router.include_router(search_integration_sources_router)
router.include_router(preview_integration_source_router)
