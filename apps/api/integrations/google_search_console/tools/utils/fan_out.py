# apps/api/integrations/google_search_console/tools/utils/fan_out.py

"""Google Search Console fan-out result serialization."""
...
def fan_out_tool_return(items: Sequence[Any]) -> ToolReturn[dict[str, Any]]:
    ...
    serialized_items = serialize_fan_out_results(items)
    model_entries: list[dict[str, Any]] = []
    display_entries: list[dict[str, Any]] = []
    for item, serialized in zip(items, serialized_items, strict=True):
