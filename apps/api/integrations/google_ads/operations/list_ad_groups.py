...
async def list_ad_groups(
    ...
    *,
    ...
    query = (
        "SELECT ad_group.id, ad_group.name, ad_group.status, ad_group.type, "  # noqa: S608 -- digit-only ids and escaped search
        "ad_group.display_custom_bid_dimension, campaign.id, campaign.name, "
