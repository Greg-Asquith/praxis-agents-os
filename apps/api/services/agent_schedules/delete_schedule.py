# apps/api/services/agent_schedules/delete_schedule.py

"""Soft-delete a workspace-scoped agent schedule."""
...
async def delete_schedule(
    ...
    *,
    ...
    schedule.soft_delete(deleted_by=actor.id, cascade=False)
    await db.flush()
