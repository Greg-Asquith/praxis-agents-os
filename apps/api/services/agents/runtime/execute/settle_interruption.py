...
from .finalize import finalize_cancelled_run, finalize_interrupted_usage, finalize_stopped_run
...
async def settle_interruption(
    ...
    *,
    ...
    if execution_control is not None:
        ...
        execution_control.interrupt(
            InterruptionReason.REQUESTED_CANCELLATION if human_cancel else reason
        )
    ...
    try:
        ...
        elif execution_control is not None:
