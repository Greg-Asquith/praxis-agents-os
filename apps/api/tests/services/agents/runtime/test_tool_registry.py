...
from integrations.google_ads.tools.apply_recommendations import (
    DEFINITION as GOOGLE_ADS_APPLY_RECOMMENDATIONS_DEFINITION,
)
...
from integrations.google_ads.tools.update_positive_keyword_status import (
    DEFINITION as GOOGLE_ADS_UPDATE_POSITIVE_KEYWORD_STATUS_DEFINITION,
)
...
def test_first_party_tool_egress_classifications_are_exhaustive() -> None:
    ...
    expected = {
        ...
        "google_ads_update_keyword_status": "external_write",
...
def test_approval_editability_declarations_cover_the_catalog_sweep() -> None:
    integration_definitions = (
        ...
        GOOGLE_ADS_UPDATE_POSITIVE_KEYWORD_STATUS_DEFINITION,
    )
    ...
    expected_editable_fields = {
        ...
        "google_ads_update_keyword_status": {"statuses"},
        "save_memory": {
            "content",
            "expires_in_days",
            "importance",
    ...
    format_expectations = {
        ...
        ("google_ads_update_keyword_status", "keywords"): "entity_list",
        ("google_ads_update_keyword_status", "statuses"): "records",
    ...
    google_ads_keyword_records = {
        ...
        if field.format == "records" and "negative" in definition.name
    }
