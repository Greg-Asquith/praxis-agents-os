...
| Microsoft Graph tools, File sources and copies, upload sessions, approvals, or previews | [Microsoft Graph](../../docs/implementation/integrations/microsoft-graph.md) |
