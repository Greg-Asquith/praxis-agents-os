...
| Microsoft Graph tools, File sources and copies, upload sessions, retained approval reviews, or previews | [Microsoft Graph](../../docs/implementation/integrations/microsoft-graph.md) |
