...
describe("delegation tool rows", () => {
  ...
  it("renders completed and failed delegate outcomes with honest status copy", () => {
    ...
    expect(completed).toContain("Conversation with Research Agent")
    expect(completed).toContain(">Agent<")
    expect(completed).toContain("Review launch evidence")
    ...
    expect(completed).not.toContain(">Task<")
    ...
    expect(denied).not.toContain("Waiting for Research Agent to reply")
    expect(running).toContain("Waiting for Research Agent to reply")
    expect(running).toContain('aria-busy="true"')
