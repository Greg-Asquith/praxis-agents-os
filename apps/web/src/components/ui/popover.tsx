  ...
  return (
    <PopoverPrimitive.Portal>
      <PopoverPrimitive.Positioner
        ...
        alignOffset={centered ? 0 : alignOffset}
        anchor={centered ? viewportCenterAnchor : undefined}
        className="isolate z-50"
        collisionAvoidance={
          centered ? { align: "none", fallbackAxisSide: "none", side: "none" } : undefined
        }
        side={centered ? "bottom" : side}
        sideOffset={centered ? ({ positioner }) => -(positioner.height / 2) : sideOffset}
      >
