...
render_template() {
  ...
  local output=$2
  local indent=$3
  MICROSOFT_GRAPH_ENV_YAML=$(python3 "$SCRIPT_DIR/helpers.py" microsoft-graph-env "$indent")
  export MICROSOFT_GRAPH_ENV_YAML
