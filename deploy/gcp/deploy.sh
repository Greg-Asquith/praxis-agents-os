...
required_vars=(
  ...
  ARTIFACT_SHARING_ENABLED ALLOW_SIGNUP ALLOW_WORKSPACE_CREATION EMAIL_PROVIDER
  ...
  JOB_MEMORY WORKER_DRAIN_MAX_SECONDS WORKER_TASK_TIMEOUT_SECONDS
